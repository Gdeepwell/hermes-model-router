...
<div class="toolbar">
<label><span data-i18n="router.tier.label">Modell</span><select id="tier"><option value="" data-i18n="router.tier.all">Mind</option><option>luna</option><option>spark</option><option>terra</option><option>sol</option><option>opus5</option><option>qwen</option><option>haiku</option></select></label>
