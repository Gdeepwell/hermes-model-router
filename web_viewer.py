...
function renderSettings(){
  ...
  const modelDescriptions={luna:'Fast, simple tasks',spark:'Read-only delegated work',terra:'General orchestrator',sol:'Security-critical, design',opus5:'External Claude Code bridge',qwen:'Alternative model'};
